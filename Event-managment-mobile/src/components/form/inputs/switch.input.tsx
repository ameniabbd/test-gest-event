  ...
  return (
    <View style={{...categoryStyle?.container, ...props.containerStyle}}>
      <View style={{...styles.subContainer, ...props.subContainerStyle}}>
        {props.labelStart && (
          <Text style={{...styles.labelStart, ...categoryStyle?.style?.labelText, ...props.labelStyle}}>
            {props.label}
          </Text>
        )}
        <RNSwitch
          ...
          ios_backgroundColor={
            !value
              ? disabled
                ? props.disabledInactiveColor || props.disabledColor || appColors.disabledBorder
        ...
        />
        {!props.labelStart && (
          <Text style={{...styles.labelEnd, ...categoryStyle?.style?.labelText, ...props.labelStyle}}>
            {props.label}
          </Text>
        )}
      </View>
