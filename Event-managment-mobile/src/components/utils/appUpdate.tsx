    ...
    <Modal visible={show}>
      <View style={styles.modalWrap}>
        <View style={styles.modalStyle}>
          ...
          <Text style={styles.textStyle}>{strings.updatedesc?.replace('{lastVersion}', lastVersion)}</Text>
          <View style={styles.btnContainer}>
            <Button
              style={styles.btn}
              title={strings.updatecta}
              onPress={() =>
...
const styles = StyleSheet.create({
  ...
  btnContainer: {width: '100%', paddingHorizontal: Size(16)},
  btn: {marginBottom: Size(5)},
  textStyle: {
    fontSize: Size(19),
    fontWeight: '600',
